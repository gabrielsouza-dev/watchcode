...
// Watch Code
import './contrib/watchCode/browser/changeDocuments.contribution.js';
...
import './contrib/watchCode/browser/timelineDecorations.contribution.js';
import './contrib/watchCode/browser/timelineNavigation.contribution.js';
