...
| Etapa | Reporter (2 de 2) |
| Entrada | Alterações de código implementadas na etapa anterior |
| Saída | Relatório consolidado apresentado ao usuário |
| Próxima etapa | — (fim do workflow) |

## Objetivo

Ler as instruções desta etapa e **reportar ao usuário** o resultado da implementação.
...
1. Reunir as informações da etapa anterior.
