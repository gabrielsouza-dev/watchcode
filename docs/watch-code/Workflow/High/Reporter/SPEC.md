...
| Etapa | Reporter (5 de 5) |
| Entrada | Artefatos das etapas anteriores (PLAN, SPEC, código, testes) |
| Saída | Relatório consolidado apresentado ao usuário |
| Próxima etapa | — (fim do workflow) |

## Objetivo

Ler a `SPEC` correspondente e **consolidar o resultado do workflow** em um relatório entregue ao usuário.
...
- O resultado da etapa Tester.

## Procedimento

1. Reunir os artefatos das etapas anteriores.
2. Consolidar o relatório do workflow com as seções obrigatórias abaixo.
...
- **Testes executados e seus resultados** — comandos, escopo e conclusão.
